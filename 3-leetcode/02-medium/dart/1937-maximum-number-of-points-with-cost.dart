class Solution {
  int maxPoints(List<List<int>> points) {
    ...
    List<int> previousRow = List<int>.filled(cols, 0);
    ...
    for (int row = 0; row < rows - 1; row++) {
      final leftMax = List<int>.filled(cols, 0);
      final rightMax = List<int>.filled(cols, 0);
      final currentRow = List<int>.filled(cols, 0);
